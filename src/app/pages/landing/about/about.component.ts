  ...
  styles: [
    `
      ...
      @keyframes pulse {
        0%,
        100% {
          box-shadow: 0 0 20px rgba(198, 39, 97, 0.2);
        }
        50% {
          box-shadow: 0 0 30px rgba(198, 39, 97, 0.5);
        }
      }
...
export class AboutComponent {
  steps = [
    {
      name: 'Inscription',
      desc: 'Créez votre compte en 2 minutes',
      icon: '📝',
      color: '#C62761',
      active: false,
    },
    {
      name: 'Paiement',
      desc: 'Payez en ligne de façon sécurisée',
      icon: '💳',
      color: '#F5A623',
      active: false,
    },
    {
      name: 'Formation',
      desc: 'Suivez votre parcours personnalisé',
      icon: '📚',
      color: '#3B82F6',
      active: true,
    },
    {
      name: 'Validation',
      desc: 'Évaluations et suivi de présence',
      icon: '✅',
      color: '#10B981',
      active: false,
    },
    {
      name: 'Certification',
      desc: 'Certificat blockchain vérifiable',
      icon: '🎓',
      color: '#8B5CF6',
      active: false,
    },
