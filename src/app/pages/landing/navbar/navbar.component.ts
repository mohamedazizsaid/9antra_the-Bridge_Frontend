    ...
    <nav class="navbar" [class.scrolled]="isScrolled" [class.mobile-open]="mobileOpen">
      ...
      <div class="mobile-drawer" *ngIf="mobileOpen">
        <a
          ...
          class="nav-link"
          [class.active]="activeSection === 'top'"
          (click)="scrollTo($event, 'top'); mobileOpen = false"
          >Accueil</a
        >
        <a
          href="#apropos"
          class="nav-link"
          [class.active]="activeSection === 'apropos'"
          (click)="scrollTo($event, 'apropos'); mobileOpen = false"
          >À propos</a
        >
        <a
          href="#fonctionnalites"
          class="nav-link"
          [class.active]="activeSection === 'fonctionnalites'"
          (click)="scrollTo($event, 'fonctionnalites'); mobileOpen = false"
          >Fonctionnalités</a
        >
        <a
          href="#contact"
          class="nav-link"
          [class.active]="activeSection === 'contact'"
          (click)="scrollTo($event, 'contact'); mobileOpen = false"
          >Contact</a
        >
        <div class="mobile-auth">
          <a routerLink="/auth/login" class="btn-nav-ghost" (click)="mobileOpen = false"
            >Se connecter</a
          >
          <a routerLink="/auth/register" class="btn-nav-primary" (click)="mobileOpen = false"
            >Commencer →</a
          >
        </div>
      </div>
