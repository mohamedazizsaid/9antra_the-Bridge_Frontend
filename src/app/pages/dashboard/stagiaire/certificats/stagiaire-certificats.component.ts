    ...
    <div class="overflow-hidden relative w-full pb-10">
      ...
      >
        ...
        <div class="w-full flex-shrink-0 min-w-full space-y-6">
            ...
            <div class="flex items-center gap-3.5">
              ...
              <div>
                <h1 class="font-syne font-bold text-2xl md:text-3xl text-white">
                  Mes Certificats Blockchain
                </h1>
                <p class="text-[var(--bridge-text-muted)] text-sm mt-0.5">
                  Certifications officielles infalsifiables et vérifiables sur le réseau
                  décentralisé
                </p>
              </div>
            </div>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div class="bridge-card p-5 relative overflow-hidden group">
              ...
              <div class="flex items-center justify-between">
                <div>
                  ...
                  <p class="text-3xl font-mono font-bold text-white mt-1.5">
                    {{ certificats.length }}
                  </p>
                </div>
                <div
            ...
            <div class="bridge-card p-5 relative overflow-hidden group">
              ...
              <p class="text-[11px] text-[var(--bridge-text-muted)] mt-3">
                Smart Contract Sécurisé SHA-256
              </p>
            </div>
            ...
            <div class="bridge-card p-5 relative overflow-hidden group">
              <div
                class="h-1 absolute top-0 left-0 right-0 bg-gradient-to-r from-[var(--bridge-gold)] to-[#C62761]"
              ></div>
              <div class="flex items-center justify-between">
                <div>
                  <p
              ...
              <p class="text-[11px] text-[var(--bridge-gold)] mt-3">
                Éligible aux opportunités partenaires
              </p>
            </div>
          </div>
          ...
          <div
            *ngIf="filteredCertificats.length > 0 && viewMode === 'grid'"
              ...
              <div>
                <div class="flex justify-between items-start mb-4">
                  ...
                  <div class="flex items-center gap-2">
                    <span
                      class="text-[10px] px-2 py-0.5 rounded-full font-bold uppercase tracking-widest border border-emerald-500/30 bg-emerald-500/10 text-emerald-400"
                    >
                      CERTIFIÉ
                    </span>
                ...
                <p
                  class="text-xs text-[var(--bridge-text-muted)] line-clamp-2 mb-4 leading-relaxed"
                >
                  {{
                ...
                <!-- Hash Box Preview -->
                <div
                  class="mb-4 p-2.5 rounded-xl bg-white/[0.02] border border-white/5 flex items-center justify-between text-xs font-mono"
                  (click)="$event.stopPropagation()"
                >
                  <span class="text-[10px] text-white/40 truncate max-w-[170px]">{{
                    cert.hashBlockchain || '0x7f83b165...d9069'
                  }}</span>
                  <button
                    (click)="copyHash(cert.hashBlockchain)"
                    class="text-[10px] text-[#C62761] hover:text-white transition-colors cursor-pointer flex items-center gap-1 font-sans font-bold"
                  >
                    Copier 📋
                  </button>
                </div>
              ...
              <div>
                <div class="border-t border-white/5 pt-3 space-y-2">
                  <div class="flex justify-between text-xs text-[var(--bridge-text-muted)]">
                    <span>Référence :</span>
                    <span class="font-semibold text-white/70 font-mono">{{
                ...
                <!-- Actions Bar -->
                <div
                  class="mt-4 flex items-center justify-between gap-2 pt-3 border-t border-white/5"
                >
                  <button
                    class="text-xs text-[#C62761] font-semibold hover:text-[#F5A623] transition-colors cursor-pointer"
                  >
          ...
          <div *ngIf="filteredCertificats.length > 0 && viewMode === 'list'" class="space-y-3">
            <div
              *ngFor="
                let cert of certsExpanded ? filteredCertificats : filteredCertificats.slice(0, 4)
              "
              (click)="openCertificate(cert)"
            ...
            >
              <div class="flex items-center gap-4">
                <div
                  class="w-10 h-10 rounded-xl bg-[var(--bridge-gold)]/10 border border-[var(--bridge-gold)]/20 text-[var(--bridge-gold)] flex items-center justify-center flex-shrink-0"
                >
                  <svg
                    class="w-5 h-5"
                    viewBox="0 0 24 24"
                ...
                <div>
                  <div class="flex items-center gap-2">
                    <h3
                      class="font-syne font-bold text-base text-white group-hover:text-[#F5A623] transition-colors"
                    >
                      {{ cert.formationNom }}
                    </h3>
                    <span
                      class="text-[9px] px-2 py-0.5 rounded-full font-bold bg-[var(--bridge-gold)]/10 text-[var(--bridge-gold)] border border-[var(--bridge-gold)]/20"
                    >
                      CERTIFIÉ
                    </span>
                  </div>
                  <p class="text-xs text-[var(--bridge-text-muted)] mt-0.5">
                    {{ cert.phaseNom || 'Cycle certifiant' }} — Délivré le
                    {{ cert.dateObtention | date: 'dd/MM/yyyy' }}
                  </p>
                </div>
              </div>
            ...
            <div *ngIf="filteredCertificats.length > 4" class="pt-2 flex justify-center">
              ...
              >
                <span>{{
                  certsExpanded
                    ? '▲ Réduire la liste'
                    : '▼ Voir plus de certificats (' + filteredCertificats.length + ')'
                }}</span>
              </button>
            </div>
          </div>
          ...
          >
            <div
              class="w-16 h-16 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-3xl mx-auto text-[var(--bridge-gold)]"
            >
              <svg
                class="w-8 h-8"
                viewBox="0 0 24 24"
            ...
            <div>
              ...
              <p class="text-xs text-[var(--bridge-text-muted)] mt-1">
                Vos certificats s'afficheront automatiquement ici dès que vous aurez validé les
                phases de vos formations.
              </p>
            </div>
            <a
        ...
        <div class="w-full flex-shrink-0 min-w-full space-y-6">
          ...
          <div
            class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 max-w-6xl mx-auto"
          >
            <button
          ...
          >
            ...
            <div
              class="bg-[#0b0b1e] rounded-[22px] p-6 sm:p-10 md:p-14 relative overflow-hidden border border-white/10"
            >
              <!-- Watermark Decorative Crest -->
              <div
                class="absolute inset-0 flex items-center justify-center opacity-[0.035] pointer-events-none"
              >
              ...
              <div
                class="border-2 border-dashed border-[var(--bridge-gold)]/40 rounded-2xl p-6 sm:p-10 relative"
              >
                <!-- 4 Corner Luxury Accents -->
                <div
                  class="absolute -top-2 -left-2 w-6 h-6 border-t-2 border-l-2 border-[var(--bridge-gold)]"
                ></div>
                <div
                  class="absolute -top-2 -right-2 w-6 h-6 border-t-2 border-r-2 border-[var(--bridge-gold)]"
                ></div>
                <div
                  class="absolute -bottom-2 -left-2 w-6 h-6 border-b-2 border-l-2 border-[var(--bridge-gold)]"
                ></div>
                <div
                  class="absolute -bottom-2 -right-2 w-6 h-6 border-b-2 border-r-2 border-[var(--bridge-gold)]"
                ></div>
                ...
                <div class="flex flex-col items-center justify-center text-center space-y-3 mb-8">
                  <div class="flex items-center gap-3">
                    <div
                      class="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#C62761] to-[#F5A623] flex items-center justify-center text-2xl font-black text-white shadow-lg"
                    >
                      9
                    </div>
                    <div class="text-left">
                      <h2
                        class="font-syne font-extrabold text-2xl text-white tracking-widest uppercase"
                      >
                        The Bridge
                      </h2>
                      <p
                        class="text-[10px] uppercase tracking-[3px] text-[var(--bridge-gold)] font-bold"
                      >
                  ...
                  <div
                    class="inline-block px-4 py-1 rounded-full bg-amber-500/10 border border-amber-500/25 mt-2"
                  >
                    <span
                      class="text-xs uppercase tracking-[4px] font-bold text-[var(--bridge-gold)]"
                    >
                ...
                <div class="text-center space-y-4 my-8">
                  ...
                  <h1
                    class="font-syne font-extrabold text-3xl sm:text-5xl md:text-6xl text-white tracking-wide py-1"
                  >
                  ...
                  <div
                    class="flex items-center justify-center gap-3 max-w-sm mx-auto my-2 opacity-60"
                  >
                    <div
                      class="h-0.5 flex-1 bg-gradient-to-r from-transparent to-[var(--bridge-gold)]"
                    ></div>
                    <span class="text-[var(--bridge-gold)] text-xs">◆</span>
                    <div
                      class="h-0.5 flex-1 bg-gradient-to-l from-transparent to-[var(--bridge-gold)]"
                    ></div>
                  </div>

                  <p class="text-sm text-white/70 max-w-2xl mx-auto leading-relaxed">
                    a accompli avec succès l'ensemble du cursus théorique et des épreuves pratiques
                    de validation pour le programme de formation certifiante :
                  </p>

                  <!-- Formation Title Card -->
                  <div
                    class="p-5 md:p-6 rounded-2xl bg-white/[0.03] border border-[var(--bridge-gold)]/35 max-w-2xl mx-auto shadow-xl"
                  >
                    <h3
                      class="font-syne font-extrabold text-xl md:text-2xl text-[var(--bridge-gold)] tracking-wide"
                    >
                ...
                <div
                  class="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-8 border-t border-white/10 mt-10 items-end"
                >
                  ...
                  <div class="text-left space-y-1">
                    ...
                    <p class="text-sm font-bold text-white">
                      {{ selectedCert.dateObtention | date: 'dd MMMM yyyy' }}
                    </p>
                    <div
                      class="flex items-center gap-1.5 text-emerald-400 text-xs font-semibold pt-1"
                    >
                  ...
                  <div class="flex flex-col items-center justify-center">
                    <div
                      class="w-20 h-20 rounded-full border-2 border-[var(--bridge-gold)]/60 bg-gradient-to-b from-[#F5A623]/20 via-[#C62761]/20 to-transparent flex flex-col items-center justify-center text-center shadow-lg"
                    >
                      <span class="text-lg">⛓️</span>
                      <span
                        class="text-[8px] font-bold text-[var(--bridge-gold)] uppercase tracking-widest leading-none mt-1"
                      >
                        9antra<br />Polygon
                      </span>
                    </div>
                    <span
                      class="text-[9px] text-white/50 font-mono mt-1.5 uppercase tracking-wider"
                    >
                  ...
                  <div class="text-right space-y-1">
                    ...
                    <p class="text-xs font-mono text-[var(--bridge-gold)]">
                      N° {{ selectedCert.certificateNumber || 'CERT-' + selectedCert.id }}
                    </p>
                  </div>
                </div>
                ...
                <div
                  class="mt-8 pt-4 border-t border-white/5 flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-left"
                >
                  <div class="space-y-0.5">
                    <p
                      class="text-[9px] uppercase tracking-widest text-[var(--bridge-gold)] font-bold"
                    >
                      Transaction Hash Blockchain (Polygon POS)
                    </p>
                    <p class="font-mono text-[10px] text-white/60 break-all">
                      {{
                        selectedCert.hashBlockchain ||
