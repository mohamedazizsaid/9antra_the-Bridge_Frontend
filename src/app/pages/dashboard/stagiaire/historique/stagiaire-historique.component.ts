  ...
  template: `
    <div class="space-y-6 animate-fadeIn pb-12">
        ...
        <div class="flex items-center gap-3.5">
          ...
          <div>
            ...
            <p class="text-[var(--bridge-text-muted)] text-sm mt-0.5">
              Bilan complet de votre parcours, registre d'assiduité, évaluations et progression
              certifiée
            </p>
          </div>
        </div>
        ...
        <div class="bridge-card p-5 relative overflow-hidden group">
          ...
          <div class="flex items-center justify-between">
            <div>
              ...
              <p
                class="text-2xl font-mono font-bold text-white mt-1.5"
                [class]="attendanceStats.rate >= 75 ? 'text-[var(--bridge-gold)]' : 'text-rose-400'"
              >
          ...
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-2xl font-mono font-bold text-white mt-1.5">
                ...
                <span class="text-xs font-sans text-white/50">/ {{ attendances.length || 0 }}</span>
              </p>
            </div>
            <div
              class="w-12 h-12 rounded-2xl bg-amber-500/10 border border-amber-500/20 text-amber-400 flex items-center justify-center flex-shrink-0"
            >
              <svg
                class="w-6 h-6"
                viewBox="0 0 24 24"
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 bridge-card p-6 space-y-4">
          <div class="flex items-center justify-between">
            ...
            <span
              class="text-xs font-mono px-2.5 py-1 rounded-lg bg-white/5 border border-white/10 text-white/70"
            >
          ...
          <div
            class="flex items-center justify-between text-[11px] text-[var(--bridge-text-muted)] font-mono border-t border-white/5 pt-3"
          >
        ...
        <div
          class="lg:col-span-1 bridge-card p-6 space-y-4 text-center flex flex-col justify-between"
        >
          <div>
          ...
          <div class="flex items-center justify-center relative my-2">
            ...
            <div class="absolute inset-0 flex flex-col items-center justify-center">
              <span class="font-mono font-black text-2xl text-white"
                >{{ attendanceStats.rate }}%</span
              >
              <span class="text-[9px] uppercase tracking-wider text-emerald-400 font-bold"
                >Assiduité</span
              >
            </div>
          </div>
      ...
      <div class="flex flex-wrap items-center justify-between gap-4">
        ...
        <div
          class="text-xs text-white/50 font-mono flex items-center gap-2 px-3.5 py-2 rounded-xl bg-white/[0.02] border border-white/5"
        >
      ...
      <div *ngIf="activeTab === 'evals'" class="space-y-6">
          ...
          >
            ...
            <div class="p-6 sm:p-8">
              <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                ...
                <div class="flex-1 space-y-4">
                  <div class="flex flex-wrap items-center gap-3">
                    ...
                    <span
                      class="text-xs text-white/60 font-mono flex items-center gap-1.5 bg-white/5 px-2.5 py-1 rounded-lg border border-white/5"
                    >
                  ...
                  <div>
                    ...
                    <div class="flex items-center gap-3 mt-1.5 text-xs text-white/50">
                      <span
                        >Formateur :
                        <strong class="text-white/80 font-medium">{{
                          e.trainerName ||
                            (e.trainerFirstName
                              ? e.trainerFirstName + ' ' + e.trainerLastName
                              : 'Formateur Expert')
                        }}</strong></span
                      >
                      <span>•</span>
                      <span class="font-mono text-white/60">{{
                        e.evaluationDate || today | date: 'dd MMMM yyyy'
                      }}</span>
                    </div>
                  </div>
                  ...
                  <div class="space-y-2 max-w-xl pt-2">
                    <div class="flex items-center justify-between text-xs">
                      ...
                      <span class="font-mono text-white/60 font-semibold"
                        >{{ ((e.grade / 20) * 100).toFixed(0) }}% des compétences validées</span
                      >
                    </div>
                    <div
                      class="h-2 w-full bg-white/5 rounded-full overflow-hidden p-0.5 border border-white/10"
                    >
                      <div
                ...
                <div
                  class="flex lg:flex-col items-center justify-between lg:justify-center p-5 rounded-2xl bg-white/[0.03] border border-white/10 flex-shrink-0 min-w-[180px] text-center shadow-lg"
                >
              ...
              <div *ngIf="e.comment" class="mt-6 pt-5 border-t border-white/5">
                <p class="text-[10px] text-white/40 uppercase tracking-widest font-semibold mb-2">
                  Appréciation Pédagogique
                </p>
                <div
                  class="p-4 rounded-2xl bg-white/[0.02] border border-white/5 text-xs text-white/80 italic leading-relaxed relative"
                >
              ...
              <div *ngIf="e.skills" class="mt-4 flex flex-wrap items-center gap-2">
                <span class="text-[10px] text-white/40 uppercase tracking-widest font-semibold mr-1"
                  >Compétences :</span
                >
                <span
        ...
        <div
          *ngIf="filteredEvaluations.length === 0 && !loading"
          class="glass-card border border-[var(--bridge-border)] p-12 text-center rounded-2xl"
        >
          <div
            class="w-16 h-16 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-3xl mx-auto mb-3"
          >
            📝
          </div>
          ...
          <p class="text-xs text-[var(--bridge-text-muted)] mt-1 max-w-md mx-auto">
            Vos appréciations pédagogiques et notes d'examens s'afficheront dès qu'elles seront
            renseignées par vos formateurs.
          </p>
        </div>
      </div>
      ...
      <div *ngIf="activeTab === 'presence'" class="space-y-6">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
          ...
          <div class="lg:col-span-1 space-y-4">
            <div
              class="glass-card border border-[var(--bridge-border)] rounded-2xl p-6 shadow-xl text-center relative overflow-hidden"
            >
              <div
              ...
              <div class="flex items-center justify-center relative my-4">
                ...
                <div class="absolute inset-0 flex flex-col items-center justify-center">
                  <span class="font-mono font-black text-3xl text-white"
                    >{{ attendanceStats.rate }}%</span
                  >
                  <span
                    class="text-[9px] uppercase tracking-wider text-emerald-400 font-bold mt-0.5"
                    >Présence</span
                  >
                </div>
              </div>
          ...
          <div class="lg:col-span-2 space-y-4">
            ...
            >
              <div
                ...
                [class]="presenceExpanded ? '' : 'max-h-[420px] overflow-y-auto'"
              >
                    ...
                    >
                      <td class="py-3 px-4">
                        <p class="font-bold text-white">
                          {{ a.seanceTitre || a.formationNom || 'Séance Pédagogique' }}
                        </p>
                        <p class="text-[10px] text-[var(--bridge-text-muted)]">
                          {{ a.phaseNom || 'Cycle standard' }}
                        </p>
                      </td>
                      ...
                      <td class="py-3 px-4 text-white/60">
                        ...
                        <span class="block text-[10px] text-[var(--bridge-gold)]"
                          >📍 {{ a.salle || 'Salle Principale' }}</span
                        >
                      </td>
      ...
      <div *ngIf="activeTab === 'progression'" class="space-y-6">
        <div *ngIf="progressions.length > 0" class="grid gap-6">
          ...
          >
            <div
              class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-white/5"
            >
              <div>
                <span
                  class="text-[10px] px-2.5 py-1 rounded-full bg-amber-500/10 text-[var(--bridge-gold)] border border-amber-500/20 font-bold uppercase tracking-wider"
                >
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <div
                ...
                [class]="
                  prog.unlocked
                    ? 'bg-[var(--bridge-crimson)]/10 border-[var(--bridge-crimson)]/30'
                    : 'bg-white/[0.02] border-white/5'
                "
              >
                <div
                  ...
                  [class]="
                    prog.unlocked
                      ? 'bg-[var(--bridge-crimson)]/20 text-[var(--bridge-crimson)]'
                      : 'bg-white/5 text-white/30'
                  "
                >
                  {{ prog.unlocked ? '🔓' : '🔒' }}
                ...
                <div>
                  ...
                  <p
                    class="text-xs font-bold mt-0.5"
                    [class]="prog.unlocked ? 'text-[var(--bridge-gold)]' : 'text-white/60'"
                  >
            ...
            <div
              *ngIf="prog.unlocked"
              class="pt-4 border-t border-white/5 flex items-center justify-between text-xs"
            >
        ...
        >
          ...
          <p class="text-xs text-[var(--bridge-text-muted)] mt-1 max-w-md mx-auto">
            Vos étapes d'avancement dans vos formations apparaîtront automatiquement dès votre
            inscription.
          </p>
        </div>
      </div>
  ...
  get tabs() {
    return [
      { key: 'evals', icon: '⭐', label: 'Évaluations & Notes', count: this.evaluations.length },
      {
        key: 'presence',
        icon: '📅',
        label: 'Registre des Présences',
        count: this.attendances.length,
      },
      ...
      next: (progs) => {
        if (progs && progs.length > 0) {
          this.progressions = progs.map((p: any) => ({
            ...
            pedagogicalValidated:
              p.pedagogicalValidated !== undefined ? p.pedagogicalValidated : true,
