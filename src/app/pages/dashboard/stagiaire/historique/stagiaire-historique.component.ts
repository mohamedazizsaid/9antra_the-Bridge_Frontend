...
@Component({
  ...
  template: `
    <div class="space-y-8 animate-fadein pb-10">
      <!-- ════════════════════ HERO HEADER ════════════════════ -->
      <div
        class="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-r from-[#10102A] via-[#16163A] to-[#0A0A1C] p-6 sm:p-8 shadow-2xl"
      >
        <!-- Background Ambient Glows -->
        <div
          class="absolute -top-24 -right-24 w-96 h-96 rounded-full bg-[#C62761]/15 blur-3xl pointer-events-none"
        ></div>
        <div
          class="absolute -bottom-24 -left-24 w-96 h-96 rounded-full bg-[#7C3AED]/15 blur-3xl pointer-events-none"
        ></div>
        <div
          class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-white/[0.03] via-transparent to-transparent pointer-events-none"
        ></div>

        <div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div class="flex items-center gap-5">
            <div
              class="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#7C3AED] via-[#C62761] to-[#F5A623] p-0.5 shadow-xl shadow-[rgba(124,58,237,0.3)] flex-shrink-0"
            >
              <div
                class="w-full h-full bg-[#0E0E24] rounded-[14px] flex items-center justify-center text-3xl"
              >
                📜
              </div>
            </div>
            <div>
              <div class="flex items-center gap-2">
                <span
                  class="px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-widest bg-gradient-to-r from-[#C62761]/20 to-[#F5A623]/20 border border-[#F5A623]/30 text-[#F5A623]"
                >
                  Suivi Académique & Pédagogique
                </span>
              </div>
              <h1
                class="font-syne font-extrabold text-3xl sm:text-4xl text-white mt-1 tracking-tight"
              >
                Mon
                <span
                  class="bg-gradient-to-r from-[#C62761] via-[#E0452F] to-[#F5A623] bg-clip-text text-transparent"
                  >Historique</span
                >
              </h1>
              <p class="text-white/60 text-sm mt-1 max-w-xl">
                Consultez le détail de vos évaluations, le registre interactif de vos présences et
                l'avancement de votre cursus.
              </p>
            </div>
          </div>
          ...
          <div class="flex items-center gap-3 self-start md:self-center">
            ...
            <div
              class="px-5 py-3 rounded-2xl bg-white/[0.03] border border-white/10 backdrop-blur-md flex items-center gap-4"
            >
              <div
              ...
              <div>
                <p class="text-[10px] uppercase tracking-wider text-white/40 font-semibold">
                  Assiduité Globale
                </p>
                <p
                  class="font-mono font-bold text-xl leading-tight"
            ...
            >
              <div
                class="w-10 h-10 rounded-xl bg-[#F5A623]/15 border border-[#F5A623]/20 text-[#F5A623] flex items-center justify-center text-lg"
              >
                ⭐
              </div>
              <div>
                ...
                <p class="font-mono font-bold text-xl text-[#F5A623] leading-tight">
                  {{ evaluations.length }}
                </p>
              </div>
            </div>
      ...
      <div class="flex flex-wrap items-center justify-between gap-4 ">
        <div
          class="flex items-center gap-1.5 p-1.5 bg-[#10102A]/80 backdrop-blur-xl border border-white/10 rounded-2xl w-fit shadow-lg"
        >
          <button
        ...
        <div
          class="text-xs text-white/40 font-mono flex items-center gap-2 px-3 py-1.5 rounded-xl bg-white/[0.02] border border-white/5"
        >
      ...
      <div *ngIf="activeTab === 'evals'" class="space-y-6">
        ...
        <div *ngIf="loading" class="grid md:grid-cols-2 gap-6">
          <div
            *ngFor="let _ of [1, 2]"
            class="glass-card border border-white/10 p-6 animate-pulse space-y-4"
          >
        ...
        <!-- Empty State -->
        <div
          *ngIf="evaluations.length === 0 && !loading"
          class="glass-card border border-white/10 p-16 text-center rounded-3xl relative overflow-hidden"
        >
          <div
            class="w-20 h-20 rounded-3xl bg-white/5 border border-white/10 flex items-center justify-center text-4xl mx-auto mb-4"
          >
            📝
          </div>
          ...
          <p class="text-white/40 text-sm mt-2 max-w-md mx-auto leading-relaxed">
            Vos résultats d'évaluations et appréciations pédagogiques délivrés par vos formateurs
            apparaîtront ici.
          </p>
        </div>
        ...
        <div *ngIf="evaluations.length > 0" class="grid gap-6">
          <div
            *ngFor="let e of evaluations; let i = index"
          ...
          >
            ...
            <div class="p-6 sm:p-8">
              <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                ...
                <div class="flex-1 space-y-4">
                  <div class="flex flex-wrap items-center gap-3">
                    <span
                      class="px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider bg-[#C62761]/15 text-[#C62761] border border-[#C62761]/30"
                    >
                  ...
                  <div>
                    <h3
                      class="font-syne font-bold text-xl sm:text-2xl text-white group-hover:text-[#F5A623] transition-colors"
                    >
                      {{ e.phaseTitle }}
                    </h3>
                    <div class="flex items-center gap-3 mt-1.5 text-xs text-white/50">
                      <span
                        >Formateur :
                        <strong class="text-white/80 font-medium">{{ e.trainerName }}</strong></span
                      >
                      <span>•</span>
                      ...
                      <div class="flex items-center gap-1">
                        <span
                          *ngFor="let star of getStars(e.grade)"
                          [class]="
                            star
                              ? 'text-[#F5A623] drop-shadow-[0_0_8px_rgba(245,166,35,0.5)]'
                              : 'text-white/10'
                          "
                          class="text-xl"
                          >★</span
                        >
                        <span class="text-xs text-white/50 ml-2 font-mono font-bold"
                          >{{ getStarCount(e.grade) }}/5</span
                        >
                      </div>
                      <span class="font-mono text-white/40 font-semibold"
                        >{{ ((e.grade / 20) * 100).toFixed(0) }}% acquis</span
                      >
                    </div>
                    <div
                      class="h-2 w-full bg-white/5 rounded-full overflow-hidden p-0.5 border border-white/5"
                    >
                      <div
                ...
                <div
                  class="flex lg:flex-col items-center justify-between lg:justify-center p-5 rounded-2xl bg-white/[0.02] border border-white/5 flex-shrink-0 min-w-[180px] text-center"
                >
                  <span class="text-[10px] font-bold uppercase tracking-widest text-white/40 mb-1"
                    >Note Finale</span
                  >
                  <div class="flex items-baseline gap-1">
                    <span
                      class="font-mono font-black text-4xl sm:text-5xl tracking-tight"
                      [class]="getGradeTextColor(e.grade)"
                    >
                      {{ e.grade }}
                    </span>
                  ...
                  <span
                    class="mt-2 text-xs font-bold px-3 py-1 rounded-full border shadow-sm"
              ...
              <div *ngIf="e.comment" class="mt-6 pt-5 border-t border-white/5">
                <p class="text-[10px] text-white/30 uppercase tracking-widest font-semibold mb-2">
                  Appréciation Pédagogique
                </p>
                <div
                  class="p-4 rounded-2xl bg-gradient-to-r from-white/[0.03] to-transparent border border-white/5 text-sm text-white/80 italic leading-relaxed relative"
                >
                  <span
                    class="text-2xl text-[#C62761]/40 font-serif leading-none absolute top-2 left-2"
                    >“</span
                  >
              ...
              <div *ngIf="e.skills" class="mt-4 flex flex-wrap items-center gap-2">
                <span class="text-[10px] text-white/30 uppercase tracking-widest font-semibold mr-1"
                  >Compétences :</span
                >
                <span
      ...
      <div *ngIf="activeTab === 'presence'" class="space-y-5">
        ...
        <div class="flex flex-col lg:flex-row gap-5 items-start">
          ...
          <div class="w-full lg:w-72 flex-shrink-0 space-y-4 lg:sticky lg:top-4">
            ...
            <div class="glass-card rounded-3xl p-5 shadow-xl">
              ...
              <div class="space-y-2 mt-3">
                ...
                <div class="flex items-center justify-between text-xs">
                  ...
                  <span class="font-mono font-black text-rose-400">{{
            ...
            <div class="glass-card rounded-3xl p-5 shadow-xl space-y-3">
              <div class="flex items-start justify-between gap-2">
                ...
                <span
                  class="flex-shrink-0 text-[10px] font-bold px-2.5 py-1 rounded-full border"
                  [class]="
                    attendanceStats.rate >= 75
              ...
              >
                ...
                <!-- 75% threshold tick -->
                <div
                  class="absolute top-0 bottom-0 w-px bg-[#F5A623] shadow-[0_0_6px_#F5A623]"
                  style="left:75%"
                ></div>
              </div>
              ...
              <div class="mt-1 pt-3 border-t" style="border-color: var(--bridge-border)">
                ...
                >
                  <span
                    class="w-3.5 h-3.5 border-2 border-current border-t-transparent rounded-full animate-spin flex-shrink-0"
                  ></span>
                ...
                <!-- Not eligible -->
                <div
                  *ngIf="!certLoading && attendanceStats.rate < 75"
                ...
                <div
                  *ngIf="!certLoading && attendanceStats.rate >= 75 && certificates.length === 0"
                  class="flex items-start gap-2.5 px-3 py-2.5 rounded-xl"
                  ...
                  >
                    ...
                    <div
                      class="absolute inset-0 bg-gradient-to-r from-transparent via-white/5 to-transparent
                                pointer-events-none -translate-x-full group-hover:translate-x-full transition-transform duration-700"
                    ></div>

                    <div class="flex items-center gap-3 min-w-0 relative z-10">
                      <div
                        class="w-9 h-9 rounded-xl flex items-center justify-center text-white text-sm shadow-md flex-shrink-0"
                        style="background: linear-gradient(135deg, #C62761, #F5A623)"
                      >
                        <span *ngIf="!certDownloading">📄</span>
                        <span
                          *ngIf="certDownloading"
            ...
            <div class="space-y-3">
              <div
                class="glass-card rounded-2xl p-4 flex items-center gap-4 border-l-4 border-emerald-500"
              >
                <div
                  class="w-10 h-10 rounded-xl bg-emerald-500/15 flex items-center justify-center text-xl flex-shrink-0"
                >
                  ✅
                </div>
                <div>
                  <p class="text-[10px] text-white/40 uppercase tracking-wider font-semibold">
                    Séances Présentes
                  </p>
                  <p class="text-2xl font-mono font-black text-emerald-400">
                    {{ attendanceStats.present }}
                  </p>
                </div>
              </div>
              <div
                class="glass-card rounded-2xl p-4 flex items-center gap-4 border-l-4 border-rose-500"
              >
                <div
                  class="w-10 h-10 rounded-xl bg-rose-500/15 flex items-center justify-center text-xl flex-shrink-0"
                >
                  ❌
                </div>
                <div>
                  ...
                  <p class="text-2xl font-mono font-black text-rose-400">
                    {{ attendanceStats.absent }}
                  </p>
                </div>
              </div>
          ...
          <div class="flex-1 min-w-0 space-y-4">
            <!-- Empty state -->
            <div
              *ngIf="attendances.length === 0 && !loading"
            ...
            >
              ...
              <p class="text-white/40 text-sm mt-2">
                Vos fiches d'appel validées s'afficheront ici au fur et à mesure.
              </p>
            </div>
            ...
            <div *ngIf="attendances.length > 0">
              ...
              <div class="flex items-center justify-between mb-3 px-1">
                <div class="flex items-center gap-3">
                  <div
                    class="w-8 h-8 rounded-xl bg-gradient-to-br from-[#C62761] to-[#F5A623] flex items-center justify-center text-sm shadow-lg"
                  >
                    📋
                  </div>
                  <div>
                    ...
                    <p class="text-[10px] text-white/40 font-mono tracking-wide">
                      {{ attendances.length }} session(s) enregistrée(s)
                    </p>
                  </div>
                </div>
                <div
                  class="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-white/[0.04] border border-white/10"
                >
                  ...
                  <span class="text-xs font-mono font-bold text-white/60">{{
                    attendances.length
                  }}</span>
                </div>
              </div>
              ...
              <div
                [class]="
                  presenceExpanded
                    ? 'space-y-2.5'
                    : 'space-y-2.5 max-h-[620px] overflow-y-auto pr-1'
                "
                style="scrollbar-width: thin; scrollbar-color: rgba(198,39,97,0.3) transparent;"
              >
                <div
                  *ngFor="let a of attendances; let i = index"
                ...
                >
                  ...
                  <div class="pl-5 pr-4 py-3.5 flex items-center justify-between gap-4">
                    ...
                    <div class="flex items-center gap-3.5 min-w-0">
                      <!-- Session index badge -->
                      <div
                        class="w-8 h-8 rounded-lg flex items-center justify-center text-[11px] font-black flex-shrink-0 border"
                        [class]="
                          a.present
                      ...
                      <div class="min-w-0">
                        <p
                          class="text-sm font-bold text-white capitalize truncate leading-tight"
                        ...
                        <div class="flex flex-wrap items-center gap-x-2 gap-y-1 mt-1">
                          <span
                            class="text-[10px] font-bold px-2 py-0.5 rounded-full bg-[#C62761]/12 text-[#C62761] border border-[#C62761]/20 leading-none"
                          >
                            {{ a.phaseTitle || 'Phase' }}
                          </span>
                          <span
                            *ngIf="a.location"
                            class="text-[10px] text-white/40 flex items-center gap-1"
                          >
                            📍 {{ a.location }}
                          </span>
                          <span
                            *ngIf="a.startTime"
                            class="text-[10px] font-mono text-white/40 flex items-center gap-1"
                          >
                            ⏰ {{ a.startTime }}
                          </span>
                        </div>
                    ...
                    <div class="flex items-center gap-3 flex-shrink-0">
                      ...
                      >
                        <span
                          ...
                          [class]="a.present ? 'bg-emerald-400' : 'bg-rose-400'"
                        ></span>
              ...
              <div *ngIf="attendances.length > 7" class="flex justify-center pt-2">
                ...
                >
                  <span
                    ...
                    [class]="presenceExpanded ? 'rotate-180' : ''"
                    >▼</span
                  >
                  {{
                    presenceExpanded
                      ? 'Réduire le registre'
                      : 'Voir toutes les séances (' + attendances.length + ')'
                  }}
                </button>
              </div>
            </div>
      ...
      <div *ngIf="activeTab === 'progression'" class="space-y-6">
        <!-- Empty State -->
        <div
          *ngIf="progressions.length === 0 && !loading"
        ...
        >
          ...
          <p class="text-white/40 text-sm mt-2 max-w-md mx-auto">
            L'avancement dans votre cursus apparaîtra automatiquement dès la validation des
            premières étapes.
          </p>
        </div>
        ...
        <div class="space-y-6">
          <div
            *ngFor="let prog of progressions; let i = index; let last = last"
          ...
          >
            ...
            <div
              *ngIf="!last"
              class="hidden sm:block absolute left-[15px] top-[48px] w-0.5 h-[calc(100%+24px)] bg-gradient-to-b from-[#C62761] to-white/10 z-0"
            ></div>

            <!-- Timeline Bullet (Desktop) -->
            <div
              class="hidden sm:flex absolute left-0 top-[20px] w-8 h-8 rounded-full border-2 items-center justify-center z-10 bg-[#0E0E24] shadow-lg"
              [class]="
                prog.pedagogicalValidated
                  ? 'border-emerald-400 text-emerald-400 shadow-emerald-500/20'
            ...
            <div
              class="glass-card border rounded-3xl overflow-hidden transition-all duration-300 hover:border-[#C62761]/40 shadow-xl relative"
              [class]="prog.pedagogicalValidated ? 'border-emerald-500/30' : 'border-white/10'"
            >
              <div class="p-6 sm:p-8 space-y-6">
                <!-- Header -->
                <div
                  class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-white/5 pb-5"
                >
                  <div>
                    <span
                      class="text-xs font-mono font-semibold text-[#F5A623] tracking-wide uppercase"
                    >
                      {{ prog.formationTitle }}
                    </span>
                  ...
                  <span
                    class="px-4 py-1.5 rounded-full text-xs font-bold border uppercase tracking-wider self-start sm:self-center shadow-sm"
                    [class]="
                      prog.pedagogicalValidated
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <!-- Step 1: Payment -->
                  <div
                    class="p-4 rounded-2xl border transition-all flex items-center gap-4"
                    [class]="
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p
                        ...
                        [class]="prog.paymentValidated ? 'text-emerald-400' : 'text-white/60'"
                      >
                  ...
                  <div
                    ...
                    [class]="
                      prog.unlocked
                        ? 'bg-[#C62761]/[0.08] border-[#C62761]/30'
                        : 'bg-white/[0.02] border-white/5'
                    "
                  >
                    <div
                    ...
                    <div>
                      ...
                      <p
                        class="text-xs font-bold mt-0.5"
                        [class]="prog.unlocked ? 'text-[#C62761]' : 'text-white/60'"
                      >
                ...
                <!-- Footer info date -->
                <div
                  *ngIf="prog.validationDate"
                  class="pt-2 text-xs text-white/40 flex items-center gap-2 font-mono"
                >
                  <span>✨</span>
                  <span
                    >Phase officiellement validée le
                    {{ prog.validationDate | date: 'dd MMMM yyyy' : '' : 'fr' }}</span
                  >
                </div>
              </div>
            </div>
...
export class StagiaireHistoriqueComponent implements OnInit {
  ...
  downloadCertificate(cert: any): void {
    ...
    this.http
      .get(`${environment.apiUrl}/certificates/download/${cert.certificateNumber}`, {
        responseType: 'blob',
      })
      .subscribe({
        next: (blob) => {
