    ...
    <div class="space-y-8">
      ...
      >
        ...
        <div class="relative z-10 flex items-center gap-4">
          <div
            class="w-12 h-12 rounded-xl bg-[rgba(245,166,35,0.15)] flex items-center justify-center text-2xl flex-shrink-0 animate-pulse"
          >
            ⏰
          </div>
          <div class="flex-1">
      ...
      <!-- Quick Actions Bar -->
      <div
        class="flex flex-wrap gap-4 p-4 w-fit rounded-2xl bg-gradient-to-r from-[rgba(198,39,97,0.08)] to-[rgba(245,166,35,0.05)] border border-[rgba(198,39,97,0.15)] W"
      >
        <button
          (click)="goToSeances()"
      ...
      <div class="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
        ...
        >
          ...
          <p
            class="text-3xl font-mono font-bold mt-2"
        ...
        <div
          class="glass-card p-5 border border-[var(--bridge-border)] group hover:border-blue-500/30 transition-all hover:scale-[1.02]"
        >
          <p class="text-xs text-[var(--bridge-text-muted)] uppercase tracking-wider">
            Taux réussite
          </p>
      ...
      >
        <div
          class="glass-card w-full max-w-2xl max-h-[92vh] flex flex-col shadow-2xl"
        ...
        >
          ...
          >
            <div>
              ...
              <p class="text-xs text-white/40 mt-0.5" *ngIf="selectedSeance">
                ...
                {{ selectedSeance.date | date: 'EEEE d MMMM y' }} à {{ selectedSeance.heureDebut }}
              </p>
            </div>
            <div class="flex items-center gap-3">
              <!-- Live counter badge -->
              <div
                class="flex items-center gap-2 px-4 py-2.5 rounded-2xl border"
                [class]="
          ...
          <div class="flex-1 overflow-y-auto p-6 space-y-3">
            ...
            >
              <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                <div class="flex items-center gap-3">
                  <div
                    class="w-10 h-10 rounded-full flex-shrink-0 flex items-center justify-center text-xs font-bold text-white overflow-hidden"
                    [class]="
                      presence.present
          ...
          <!-- Footer -->
          <div
            class="px-6 py-4 border-t border-white/[0.06] flex flex-col sm:flex-row gap-3 flex-shrink-0"
          >
            <button
              (click)="closeSession()"
