...
@Component({
  ...
  template: `
    <div class="space-y-8">
      ...
      <!-- Quick Actions Bar -->
      <div class="flex flex-wrap gap-4 p-4 w-fit rounded-2xl bg-gradient-to-r from-[rgba(198,39,97,0.08)] to-[rgba(245,166,35,0.05)] border border-[rgba(198,39,97,0.15)] W">
      ...
      <div *ngIf="showEvalModal"
        ...
        <div class="glass-card w-full max-w-lg shadow-2xl flex flex-col max-h-[92vh]"
             (click)="$event.stopPropagation()">
